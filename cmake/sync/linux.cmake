...
if(NOT DEFINED RF_OPERATION OR NOT RF_OPERATION STREQUAL "sync")
    message(FATAL_ERROR "RF1467 Linux Stage-1 accepts only RF_OPERATION=sync")
endif()
...
include("${RF_REPOSITORY_ROOT}/cmake/sync/portable_closure.cmake")
include("${RF_REPOSITORY_ROOT}/cmake/sync/linux_closure.cmake")
include("${RF_REPOSITORY_ROOT}/cmake/sync/linux_prepare.cmake")
...
rf_sync_verify_complete_linux_closure(
...
# the artifact, so it neither joins nor perturbs the counted Linux selection.
rf_sync_publish_verification_corpus(
    "${RF_REPOSITORY_ROOT}" "${RF_HOST}" "${RF_transport_absolutePath}"
)

rf_prepare_linux_tools("${RF_REPOSITORY_ROOT}")
rf_prepare_linux_vcpkg("${RF_REPOSITORY_ROOT}")

file(MAKE_DIRECTORY "${RF_REPOSITORY_ROOT}/out/reports/task-0001/linux-x86_64")
file(WRITE "${RF_REPOSITORY_ROOT}/out/reports/task-0001/linux-x86_64/stage1-cas.json.tmp"
    "{\n  \"host\": \"linux-x86_64\",\n  \"selectedArtifacts\": 35,\n  \"publishedStage1Artifacts\": 21,\n  \"preparedToolTrees\": 3,\n  \"preparedProviderTrees\": 1,\n  \"state\": \"verified_prepared\"\n}\n"
)
file(RENAME
    "${RF_REPOSITORY_ROOT}/out/reports/task-0001/linux-x86_64/stage1-cas.json.tmp"
    "${RF_REPOSITORY_ROOT}/out/reports/task-0001/linux-x86_64/stage1-cas.json"
)
message(STATUS "RF1468 complete Linux artifact closure verified, published to CAS, and prepared")
