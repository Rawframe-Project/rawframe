...
find_program(PERL NAMES perl.exe HINTS ENV RAWFRAME_PREPARED_PERL_BIN ENV PATH NO_DEFAULT_PATH REQUIRED)
...
if(OPENSSL_ARCH MATCHES "CLANGASM")
    ...
    find_program(NASM NAMES nasm.exe HINTS ENV RAWFRAME_PREPARED_NASM_DIR ENV PATH NO_DEFAULT_PATH REQUIRED)
...
# vcpkg loads no Visual Studio environment here (compilers come from the
# chainload toolchain), so resolve nmake from the locked MSVC tools directory
# and expose the locked MSVC/SDK bin directories to the nmake build.
find_program(NMAKE NAMES nmake.exe HINTS ENV RAWFRAME_PREPARED_MSVC_BIN ENV PATH NO_DEFAULT_PATH REQUIRED)
get_filename_component(NMAKE_EXE_PATH "${NMAKE}" DIRECTORY)
vcpkg_add_to_path("${NMAKE_EXE_PATH}")
if(DEFINED ENV{RAWFRAME_PREPARED_SDK_BIN})
    vcpkg_add_to_path("$ENV{RAWFRAME_PREPARED_SDK_BIN}")
endif()
